...
const Bilibili = () => {
	return (
		<svg viewBox="0 0 1129 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
			<path
	...
	return (
		...
		>
			...
			>
				<IconButton
					color="inherit"
					onClick={() => window.open("https://github.com/creation-hy")}
					aria-label="GitHub"
					sx={{alignSelf: 'center'}}
				>
					<GitHub/>
				...
				<IconButton
					color="inherit"
					onClick={() => window.open("https://space.bilibili.com/1679888080")}
					aria-label="Bilibili"
					sx={{alignSelf: 'center', width: 40, height: 40}}
				>
					<Bilibili/>
				</IconButton>
			</Stack>
